	<script src="/lib/scripts/jquery-1.8.3.min.js" type="text/javascript"></script>
	...
	<script src="/lib/scripts/jquery.form.js" type="text/javascript"></script>
	...
	<script src="/lib/scripts/jquery.dataTables.js" type="text/javascript"></script>
	<script src="/lib/scripts/jquery.MultiFile.js" type="text/javascript"></script>
	<script src="/lib/scripts/jquery.collapsible.min.js" type="text/javascript"></script>
	...
	<script src="/lib/scripts/jquery.sticky.js" type="text/javascript"></script>
	<script src="/lib/scripts/jquery.fancybox.js" type="text/javascript"></script>
