...
function Submit() {ldelim}
	window.opener.document.location.href='index.php?&do=docs&action=new&rubric_id='+ document.NewDoc.rubric_id.value +'&cp={$sess}';
	window.close();
{rdelim}
</script>
<div class="first"></div>
...
<div class="widget" style="margin-top: 0px;">
    <div class="body">
		Для добавления нового документа, пожалйста выберите рубрику.
    </div>
</div>
	...
	<table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
		<tr class="noborder">
			...
			<td>
				...
				&nbsp;&nbsp;&nbsp;<input type="submit" class="basicBtn" value="Добавить документ">
			</td>
		</tr>
	</table>
</form>
