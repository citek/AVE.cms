...
<div class="grid_4">
		...
		<span><img class="tip_help" title="{$la.olh_host}" src="data/tpl/images/info.png" alt="" width="16" height="16" /></span>
</div>
...
<div class="grid_4">
		...
		<img class="tip_help" title="{$la.olh_name}" src="data/tpl/images/info.png" alt="" width="16" height="16" />
</div>
...
<div class="grid_4">
		...
		<img class="tip_help" title="{$la.olh_prf}" src="data/tpl/images/info.png" alt="" width="16" height="16" />
</div>
...
<div class="grid_4">
		...
		<img class="tip_help" title="{$la.olh_user}" src="data/tpl/images/info.png" alt="" width="16" height="16" />
</div>

<div class="grid_4">
		<label for="dbpass" class="step2">{$la.dbpass}</label>
		<input name="dbpass" size="30" type="text" id="dbpass" value="" />
		<img class="tip_help" title="{$la.olh_pass}" src="data/tpl/images/info.png" alt="" width="16" height="16" />
</div>
