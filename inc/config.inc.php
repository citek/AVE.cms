<?	//Использовать ЧПУ<br> Адреса вида index.php будут преобразованы в /home/
	...
	define('DEFAULT_ADMIN_THEME_FOLDER','default');

	//Цвет панели администратора
	define('DEFAULT_THEME_FOLDER_COLOR','wood');

	//Директория для хранения файлов
	define('UPLOAD_DIR','uploads');

	//Директория для хранения миниатюр Магазина
	define('UPLOAD_SHOP_DIR','uploads/shop');

	//Директория для хранения миниатюр Галерей
	define('UPLOAD_GALLERY_DIR','uploads/gallery');

	//Директория для хранения миниатюр изображений
