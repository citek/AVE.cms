...
<form action="index.php?do=modules&action=modedit&mod=mailer&moduleaction=savelist&id={$smarty.request.id}&return=1&cp={$sess}" method="post" class="mainForm" enctype="multipart/form-data">
  ...
  <div class="widget first" id="receivers_list">
    ...
    <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
      ...
      <thead>
        <tr>
          <td align="center"><div align="center"><a href="javascript:void(0);" style="cursor:help;" class="rightDir icon_sprite ico_info" title="{#MAILER_REC_STATUS_I#}"></a></div></td>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
      <tr>
        ...
        <td>
          ...
          <div class="pr12" style="margin-top:10px;">
            <label style="float:left;padding-left:0;">{#MAILER_LISTS_IMPORT_T_1#}</label><input class="mousetrap" type="text" autocomplete="off" name="import_delim_1" style="width:30px;float:left;text-align:center;" value="\r\n" />
            <label style="float:left">{#MAILER_LISTS_IMPORT_T_2#}</label><input class="mousetrap" type="text" autocomplete="off" name="import_delim_2" style="width:30px;float:left;text-align:center;" value="," />
          </div>
      ...
      <tr>
        ...
        <td>
          ...
          <div class="pr12" style="margin-top:10px;">
            <label style="float:left;padding-left:0">{#MAILER_LISTS_IMPORT_F_D#}</label><input class="mousetrap" type="text" autocomplete="off" name="import_file_delim" style="width:30px;float:left;text-align:center;" value=";" />
          </div>
          <div class="pr12" style="clear:both;">
