...
if (defined('ACP'))
{
    ...
    $modul['ModulVersion'] = '3.0';
    $modul['description'] = 'Gallery + Watermark<br />Внимание! У директорий uploads/gallery/.upload/ и uploads/gallery/.temp/ должны быть права на запись!<br />Вы можете ограничить количество выводимых изображений, указав после Gallery-ID следующее: -3 (в этом случае количество будет ограничено тремя изображениями на страницу)';
    $modul['Autor'] = 'cron';
    ...
    $modul['CpEngineTagTpl'] = '[mod_gallery:XXX-Лимит]';
